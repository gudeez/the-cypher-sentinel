#!/usr/bin/env python3
"""
Export X/Twitter session cookies for use with The Cipher Sentinel.
...
def main():
    print("\n  X Cookie Exporter for The Cipher Sentinel")
    print("  " + "=" * 40)
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            print("  The Cipher Sentinel will now use these for X scraping.\n")
